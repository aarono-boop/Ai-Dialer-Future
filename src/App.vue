          ...
          <div class="flex-1 overflow-y-auto flex flex-col gap-8 pr-2 pb-4" ref="chatMessages">
            ...
            <div class="flex flex-col">
              <template v-for="(message, index) in messages" :key="index">
                ...
                <ChatMessage v-if="message.type !== 'separator'" :message="message" :isWide="shouldBeWideMessage(message, index)" :onTypingProgress="scrollToBottom" @typing-complete="handleTypingComplete(index)">
