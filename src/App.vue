        ...
        <div style="display: flex; align-items: flex-start; gap: 16px;">
          ...
          <div style="flex: 1;">
            ...
            <div style="display: flex; align-items: flex-start; gap: 16px;">
              ...
              <button style="background-color: rgb(59, 130, 246); color: white; border: none; border-radius: 6px; padding: 8px 16px; font-size: 14px; font-weight: 500; cursor: pointer; display: inline-flex; align-items: center; gap: 8px; flex-shrink: 0;" onclick="handleExportFile()">
