                      ...
                      <div class="flex gap-4 items-stretch">
                        ...
                        <Card class="flex-1" :pt="{ root: { style: { background: 'var(--p-surface-800)', border: '1px solid var(--p-surface-600)', borderRadius: '8px', height: '10rem', display: 'flex', flexDirection: 'column' } }, body: { style: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' } } }">
                          ...
                          <div class="flex items-center justify-center w-full h-full">
                            <img src="https://cdn.builder.io/api/v1/image/assets%2F5aeb07ce25f84dbc869290880d07b71e%2Fef6624953e4140599503bf95a33e21b2?format=webp&width=800" alt="HubSpot logo" style="height: 56px; width: auto; display: block; filter: drop-shadow(0 1px 2px rgba(0,0,0,0.6));" />
                          </div>
                        </Card>
                      </div>
                    </div>
