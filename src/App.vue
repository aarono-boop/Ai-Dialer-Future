    ...
    <main v-if="currentPage === 'main'" class="ml-16 flex-1 flex items-start justify-center p-8 relative z-[5]" :style="showDialer ? 'margin-right: 33.333333%' : ''">
      <div class="flex gap-6 w-full max-w-[1400px] h-[80vh] mt-2.5">
        ...
        <div class="w-full max-w-6xl mx-auto rounded-xl px-5">
          ...
          <div class="flex-1 overflow-y-auto flex flex-col gap-8 pr-2 pb-26" ref="chatMessages">
            <!-- Chat Messages Area -->
            <div class="flex flex-col">
              <template v-for="(message, index) in messages" :key="index">
                <!-- Regular Chat Message -->
                <ChatMessage v-if="message.type !== 'separator'" :message="message" :isWide="shouldBeWideMessage(message, index)" :onTypingProgress="scrollToBottomDuringTyping" @typing-complete="handleTypingComplete(index)">
...
const { scrollToBottom, scrollToBottomDuringTyping, scrollToUserMessage, addAIMessage, addAIMessageWithoutScroll, addUserMessage, addSeparatorMessage, addAIMessageWithTyping } = chatUtils
