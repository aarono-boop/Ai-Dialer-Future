          ...
          <div class="flex-1 overflow-y-auto flex flex-col gap-8 pr-2" :class="showDialer ? 'pb-10' : 'pb-32'" ref="chatMessages">
            ...
            <div class="flex flex-col">
              <template v-for="(message, index) in messages" :key="index">
                ...
                <ChatMessage v-if="message.type !== 'separator'" :message="message" :isWide="shouldBeWideMessage(message, index)" :onTypingProgress="message.preserveUserPosition ? undefined : scrollToBottomDuringTyping" :coachParameter="coachParameter" @typing-complete="handleTypingComplete(index)">
