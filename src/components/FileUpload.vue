<template>
  <div class="max-w-[80%] my-6 flex flex-col justify-start items-start gap-4">
    <div
      ...
      class="w-full h-32 bg-gray-800/80 border border-gray-600 rounded-lg relative cursor-pointer hover:bg-gray-800/90 transition-all duration-300 flex items-center justify-center"
    >
