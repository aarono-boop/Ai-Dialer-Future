<template>
  <div class="w-full h-full bg-gray-900 rounded-lg border border-gray-700 flex flex-col py-3 px-2.5">
    ...
    <!-- Action Buttons -->
    <div class="mx-2 mb-2 bg-gray-800 border border-gray-600 rounded-lg p-3">
