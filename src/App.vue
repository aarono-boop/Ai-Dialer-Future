    ...
    <main v-if="currentPage === 'main'" class="flex-1 flex items-start justify-center p-8 relative z-[5]">
      <div class="flex gap-6 w-full max-w-[1400px] h-[80vh] mt-2.5">
        ...
        <div :class="showDialer ? 'w-2/3' : 'w-full max-w-6xl mx-auto'" class="rounded-xl p-5">
          ...
          <div v-if="showActionButtons" class="mt-2 flex justify-center">
            <div class="w-[70%]">
              <ActionButtons
          ...
          <div v-if="showContactPreviewButtons" class="mt-2 flex justify-center">
          ...
          <div v-if="showPhoneVerificationButton" class="mt-2 flex justify-center">
            <div class="w-[70%]">
              <button
          ...
          <div v-if="showVerificationButtons" class="mt-2 flex justify-center">
            <div class="w-[70%] flex gap-3">
              <button
          ...
          <div v-if="showStartDialingButton" class="mt-2 flex justify-center">
            <div class="w-[70%]">
              <button
          ...
          <div v-if="showDispositionButtons" class="mt-2 flex justify-center">
          ...
          <div v-if="showSignupButtons && !isSignedIn" class="mt-2 flex justify-center">
            <div class="w-[70%]">
              <SignupButtons
