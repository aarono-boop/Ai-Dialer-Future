    ...
    <main class="flex-1 flex items-center justify-center p-8 relative z-[5]">
      <div class="max-w-[900px] w-full bg-white/5 backdrop-blur-[20px] border border-white/10 rounded-xl p-5 shadow-2xl">
        <div class="w-full flex flex-col gap-8">
          ...
          <!-- Chat Messages Area -->
          <div class="max-h-[512px] overflow-y-auto flex flex-col mb-4 pr-2 scrollbar-thin scrollbar-track-white/10 scrollbar-thumb-white/30 hover:scrollbar-thumb-white/50" ref="chatMessages">
